...
const getCalendar = async () => {
  try {
    const resp10 = await fetch("http://localhost:3001/10Pessoas");
    const data10 = await resp10.json();

    const resp8 = await fetch("http://localhost:3001/8Pessoas");
    const data8 = await resp8.json();

    const resp7 = await fetch("http://localhost:3001/7Pessoas");
